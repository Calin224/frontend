...
async function sendEmail(req, res) {
  try {
    await sendgrid.send({
      to: "sanducalinm@gmail.com", // Your email where you'll receive emails
      from: "sanducalinm@gmail.com", // your website email address here
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
              ...
              <h3>You've got a new mail from ${req.body.fullname}, their email is: ✉️${req.body.email} ${req.body.name} </h3>
